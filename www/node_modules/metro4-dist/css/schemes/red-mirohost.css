...
.textarea.focused,
.select.focused {
  -webkit-box-shadow: 0 0 0 3px rgba(176, 0, 21, 0.45);
          box-shadow: 0 0 0 3px rgba(176, 0, 21, 0.45);
}
.input,
.select,
.textarea,
...
.checkbox input[type=checkbox]:disabled ~ .check {
  border-color: rgba(176, 0, 21, 0.25);
  background-color: rgba(176, 0, 21, 0.25);
}
...
.accordion .frame + .frame {
  border-top: 1px rgba(176, 0, 21, 0.25) solid;
}
.h-menu {
  background-color: #B00015;
  color: #ffffff;
...
.d-menu .disabled,
.v-menu .disabled {
  color: rgba(176, 0, 21, 0.5) !important;
}
.v-menu .v-menu {
...
[class*=app-bar-expand] .app-bar-container .d-menu {
  -webkit-box-shadow: none!important;
          box-shadow: none!important;
  border: 1px solid #B00015 !important;
  background-color: #ffffff !important;
...
.calendar .day.selected {
  -webkit-box-shadow: 0 0 0 1px #b00015 !important;
          box-shadow: 0 0 0 1px #b00015 !important;
}
.calendar .day.selected::after {
  border-top-color: #B00015;
}
...
.calendar .calendar-footer {
  border-top-color: rgba(176, 0, 21, 0.25);
}
.calendar .week-days {
  border-top-color: rgba(176, 0, 21, 0.25);
  border-bottom-color: rgba(176, 0, 21, 0.25);
}
[class*=calendar-wide] .calendar-footer {
  border-left-color: rgba(176, 0, 21, 0.25);
}
.countdown {
  line-height: 1.5;
}
...
.panel {
  background-color: #252525;
  color: #919396;
  border-color: rgba(176, 0, 21, 0.25) !important;
}
.panel .panel-title {
  background-color: #B00015;
  color: #ffffff;
...
.rating:not(.static) .stars li:hover ~ li {
  color: rgba(176, 0, 21, 0.25) !important;
}
.sidenav-simple,
.sidenav-counter {
  background-color: #212121;
