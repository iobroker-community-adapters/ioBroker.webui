...
.d-menu .disabled,
.v-menu .disabled {
  color: rgba(88, 91, 93, 0.5) !important;
}
.v-menu .v-menu {
...
[class*=app-bar-expand] .app-bar-container .d-menu {
  -webkit-box-shadow: none!important;
          box-shadow: none!important;
  border: 1px solid #585b5d !important;
  background-color: #ffffff !important;
...
.calendar .day.selected {
  -webkit-box-shadow: 0 0 0 1px #585b5d !important;
          box-shadow: 0 0 0 1px #585b5d !important;
}
...
.panel {
  background-color: #3a3a3a;
  color: #BBBBBB;
  border-color: rgba(88, 91, 93, 0.25) !important;
}
.panel .panel-title {
  background-color: #585b5d;
  color: #ffffff;
...
.rating:not(.static) .stars li:hover ~ li {
  color: rgba(88, 91, 93, 0.25) !important;
}
.sidenav-simple,
.sidenav-counter {
  background-color: #2B2B2B;
