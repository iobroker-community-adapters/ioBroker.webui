import { newElementFromString, DesignItem, CssAttributeParser, DomConverter } from "@node-projects/web-component-designer";
...
export class NodeHtmlParserService {
    ...
    _createDesignItemsRecursive(item, serviceContainer, instanceServiceContainer, namespace, snippet, positionOffset = 0) {
        ...
        if (item.nodeType == 1) {
            ...
            element = DesignItem.updateRenderedNode(serviceContainer, element);
    ...
    _addAttributeSourceParts(item, designItem, serviceContainer, snippet, positionOffset) {
        ...
        while (match = attributeRegex.exec(rawAttrs)) {
            ...
            if (valueRange) {
                ...
                const context = { designItem, sourceKind: 'attribute', name: attributeName, value: valueRange.value, valueTextRange: textRange };
    ...
    _getAttributeValueRange(attributeText) {
