...
export class CodeViewMonaco extends BaseCustomWebComponentLazyAppend {
    ...
    _setSelectionTimeout;
    _pendingSelectionKey;
    dispose() {
    ...
    `;
    static template = html `<div id="container" style="overflow: hidden; width: 100%; height: 100%; position: absolute;"></div>`;
    ...
    async ready() {
        ...
        this.shadowRoot.adoptedStyleSheets = [CodeViewMonaco._monacoStyle, this.constructor.style];
