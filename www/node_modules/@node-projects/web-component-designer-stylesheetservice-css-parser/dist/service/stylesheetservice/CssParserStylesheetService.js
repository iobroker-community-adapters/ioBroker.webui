...
import { AbstractStylesheetService } from "@node-projects/web-component-designer";
export class CssParserStylesheetService extends AbstractStylesheetService {
    keepFormatting;
    constructor(designerCanvas, keepFormatting = true) {
    ...
    async addRule(stylesheet, selector) {
    ...
    resolveNestedSelectors(parentSelectors, nestedSelectors) {
    ...
    *getRulesFromAst(cssAtRuleAst, stylesheet, designItem, parentSelectors) {
    ...
    async updateCompleteStylesheet(name, newStyle) {
        this.updateCompleteStylesheetInternal(name, newStyle, 'styleupdate');
    }
    async updateCompleteStylesheetWithoutUndo(name, newStyle, noUndo = false) {
        this.updateCompleteStylesheetInternal(name, newStyle, 'undo');
    }
    async updateCompleteStylesheetInternal(name, newStyle, changeSource) {
