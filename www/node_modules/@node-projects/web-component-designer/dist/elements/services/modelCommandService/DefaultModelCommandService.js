...
export class DefaultModelCommandService {
    canExecuteCommand(designerCanvas, command, designItems) {
    ...
    async executeCommand(designerCanvas, command, designItems) {
...
//# sourceMappingURL=DefaultModelCommandService.js.map