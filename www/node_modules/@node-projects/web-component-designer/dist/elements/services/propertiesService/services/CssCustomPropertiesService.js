...
export class CssCustomPropertiesService extends AbstractCssPropertiesService {
    ...
    async getProperties(designItem) {
        ...
        let rootMap = Array.from(getComputedStyle(designItem.instanceServiceContainer.designerCanvas)).map(x => x[0]).filter(key => key.startsWith("--"));
...
//# sourceMappingURL=CssCustomPropertiesService.js.map