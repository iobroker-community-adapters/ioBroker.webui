...
export class CssPropertyEditor {
    element;
    property;
    designItems;
    _innerEditor;
    _importantButton;
    _value;
    _disableChangeNotification = false;
    constructor(property, createInnerEditor) {
    ...
    _createServiceProxy(service) {
        const proxy = Object.create(service);
        proxy.setValue = async (designItems, property, value) => service.setValue(designItems, this.property, this._appendImportant(value));
        proxy.previewValue = async (designItems, property, value) => service.previewValue?.(designItems, this.property, this._appendImportant(value));
        proxy.removePreviewValue = async (designItems, property) => service.removePreviewValue?.(designItems, this.property);
        proxy.clearValue = (designItems, property, clearType) => service.clearValue(designItems, this.property, clearType);
        return proxy;
    }
    _appendImportant(value) {
    ...
    _refreshImportant(valueType, value) {
...
//# sourceMappingURL=CssPropertyEditor.js.map