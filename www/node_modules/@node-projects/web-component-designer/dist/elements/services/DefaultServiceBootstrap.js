...
export function createDefaultServiceContainer() {
    ...
    serviceContainer.designerContextMenuExtensions = [
        ...
        new SeperatorContextMenu(),
        new ChildContextMenu('modify', new RotateLeftAndRight(), new SeperatorContextMenu(), new ZMoveContextMenu(), new SeperatorContextMenu(), new AlignItemsContextMenu(), new SeperatorContextMenu(), new BasicContextMenu({ title: '3D transform', action: (e, designerCanvas, designItem) => {
