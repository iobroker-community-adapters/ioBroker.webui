...
export class AbstractHtmlWriterService {
    ...
    writeAttributes(indentedTextWriter, designItem, updatePositions = false) {
    ...
    _writeAttributeWithValue(indentedTextWriter, designItem, attributeName, writtenValue, quote, updatePositions) {
        ...
        const context = { designItem, sourceKind: 'attribute', name: attributeName, value: writtenValue, valueTextRange: valueRange };
    ...
    _addAttributeSourcePart(designItem, attributeName, textRange) {
...
//# sourceMappingURL=AbstractHtmlWriterService.js.map