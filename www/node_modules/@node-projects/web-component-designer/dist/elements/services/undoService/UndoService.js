...
export class UndoService {
    ...
    commitTransactionItem(transactionItem) {
        ...
        if (this._transactionStack.length == 0) {
            ...
            this.emitTransaction(transactionItem, 'execute', transactionItem.source ?? 'local');
        }
    }
    ...
    *getRedoEntries(count = 999) {
    ...
    onTransaction = new TypedEvent();
    emitTransaction(item, kind, source) {
        this.onTransaction.emit({ item, kind, source });
    }
}
//# sourceMappingURL=UndoService.js.map