...
export class DesignItem {
    ...
    *styles() {
    ...
    _withoutUndoSetStyle(name, value, important = false) {
        let nm = name;
        if (!nm.startsWith('--'))
            nm = PropertiesHelper.camelToDashCase(name);
    ...
    *children(recursive = false) {
    ...
    static updateRenderedNode(serviceContainer, node) {
    ...
    removePropertyAndAttribute(name) {
        const attributeName = PropertiesHelper.camelToDashCase(name);
        const propertyName = PropertiesHelper.dashToCamelCase(name);
    ...
    _insertChildsInternal(designItems, index) {
