...
export class LayerDepthView extends BaseCustomWebComponentConstructorAppend {
    static style = css `
        :host {
          overflow: hidden;
          display: block;
    ...
    constructor() {
        ...
        this._viewport = this._getDomElement('viewport');
        this._scene = this._getDomElement('scene');
        this._content = this._getDomElement('content');
        this._empty = this._getDomElement('empty');
        this._depthSlider = this._getDomElement('depthSlider');
        this._depthValue = this._getDomElement('depthValue');
    ...
    _copyAdoptedStyleSheets(rootDesignItem) {
    ...
    _createLayerTree() {
        ...
        for (const designItem of rootDesignItem.children()) {
            ...
            const clone = designItem.element.cloneNode(true);
            fragment.appendChild(clone);
            count = this._prepareCloneTree(designItem, clone, count);
        }
        return { fragment, count };
    }
    _prepareCloneTree(designItem, clone, layerIndex) {
    ...
    _prepareCloneElement(clone, layerIndex) {
    ...
    _updateLayerDepths() {
        ...
        const depthToZ = (depth) => ((depth - minDepth) / depthRange - 0.5) * this._depthSpacing * 2;
...
//# sourceMappingURL=layerDepthView.js.map