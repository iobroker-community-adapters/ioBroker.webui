...
export class DesignerCanvas extends BaseCustomWebComponentLazyAppend {
  ...
  `;
    ...
    initialize(serviceContainer) {
        ...
        const collaborationService = this.serviceContainer.getLastService('collaborationService');
        if (collaborationService) {
            const instance = collaborationService(this);
            this.instanceServiceContainer.collaborationService = instance;
            this.instanceServiceContainer.register("collaborationService", instance);
        }
    ...
    async _searchRun() {
        ...
        if (input.value != "") {
            ...
            if (result?.length > 0) {
                ...
                this._getDomElement('node-projects-designer-search-result').innerHTML = result.length.toString() + " selected";
            }
        }
    }
    onKeyUp(event) {
    ...
    _pointerEventHandlerCapture(event, forceElement = null) {
        this.fillCalculationrects();
        if (this._pointerextensions) {
