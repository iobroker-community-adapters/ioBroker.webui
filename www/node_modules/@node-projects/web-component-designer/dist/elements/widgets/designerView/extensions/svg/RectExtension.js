...
export class RectExtension extends AbstractExtension {
    ...
    _drawPathCircle(x, y, r, index, circle) {
        let newCircle = this._drawCircle((this._parentRect.x - this.designerCanvas.containerBoundingRect.x) / this.designerCanvas.scaleFactor + x, (this._parentRect.y - this.designerCanvas.containerBoundingRect.y) / this.designerCanvas.scaleFactor + y, 5 / this.designerCanvas.scaleFactor, 'svg-path', circle);
...
//# sourceMappingURL=RectExtension.js.map