...
export class TextShadowEditorWindow extends DraggableToolWindow {
    ...
    _copyBtn;
    _applyBtn;
    get windowTitle() { return 'Text Shadow Editor'; }
    ...
    constructor(designerCanvas) {
        ...
        this._layerList = this._getDomElement('tse-layer-list');
        this._removeBtn = this._getDomElement('tse-remove-btn');
        this._enabledCheck = this._getDomElement('tse-enabled');
        this._inputX = this._getDomElement('tse-x');
        this._inputY = this._getDomElement('tse-y');
        this._inputBlur = this._getDomElement('tse-blur');
        this._inputColor = this._getDomElement('tse-color');
        this._inputOpacity = this._getDomElement('tse-opacity');
        this._opacityVal = this._getDomElement('tse-opacity-val');
        this._previewText = this._getDomElement('tse-preview');
        this._cssOutput = this._getDomElement('tse-css-out');
        this._loadBtn = this._getDomElement('tse-load-btn');
        this._copyBtn = this._getDomElement('tse-copy-btn');
        this._applyBtn = this._getDomElement('tse-apply-btn');
        this._getDomElement('tse-add-btn').onclick = () => this._addLayer();
        this._getDomElement('tse-dup-btn').onclick = () => this._duplicateLayer();
        this._getDomElement('tse-up-btn').onclick = () => this._moveLayer(-1);
        this._getDomElement('tse-down-btn').onclick = () => this._moveLayer(1);
    ...
    _loadControls() {
        ...
        this._getDomElement('tse-x-val').textContent = l.offsetX + 'px';
        this._inputY.value = String(l.offsetY);
        this._getDomElement('tse-y-val').textContent = l.offsetY + 'px';
        this._inputBlur.value = String(l.blur);
        this._getDomElement('tse-blur-val').textContent = l.blur + 'px';
