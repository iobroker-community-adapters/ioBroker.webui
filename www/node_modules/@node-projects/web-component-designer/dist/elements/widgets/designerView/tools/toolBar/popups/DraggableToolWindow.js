 ...
 */
export class DraggableToolWindow extends BaseCustomWebComponentConstructorAppend {
    static style = css `
    :host {
      position: fixed;
      display: block;
  ...
  `;
    ...
    get windowContentStyle() { return null; }
    _dragging = false;
    _dragOffsetX = 0;
    _dragOffsetY = 0;
    _titleBar;
    ...
    constructor() {
        super();
        this._titleBar = this._getDomElement('title-bar');
        this._titleText = this._getDomElement('title-text');
        this._closeBtn = this._getDomElement('close-btn');
        this._contentArea = this._getDomElement('window-content');
        //@ts-ignore
        ...
        this._titleBar.addEventListener('pointerdown', (e) => this._onPointerDown(e));
    }
    connectedCallback() {
     ...
     */
    static showWindow(instance, anchor) {
        if (anchor) {
...
//# sourceMappingURL=DraggableToolWindow.js.map