...
export class DrawToolPopup extends AbstractBaseToolPopup {
    ...
    //todo currentvalue
    getEditor(commandType, type, additional, currentValue) {
        const res = this.designerCanvas.serviceContainer.forSomeServicesTillResult('editorTypeService', x => x.getEditor(type, {
