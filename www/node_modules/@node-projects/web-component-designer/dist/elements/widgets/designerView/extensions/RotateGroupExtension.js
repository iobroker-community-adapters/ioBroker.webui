...
export class RotateGroupExtension extends AbstractExtension {
    ...
    refresh(cache, event) {
        const selection = filterChildPlaceItems(this.designerCanvas.instanceServiceContainer.selectionService.selectedElements);
        ...
        if (this._elementStartStates) {
            ...
            const rx = (x, y) => this._groupCenter.x + (x - this._groupCenter.x) * cos - (y - this._groupCenter.y) * sin;
            const ry = (x, y) => this._groupCenter.y + (x - this._groupCenter.x) * sin + (y - this._groupCenter.y) * cos;
        ...
        if (!this._rotateCircle) {
            ...
            this._rotateCircle.addEventListener('pointerdown', e => {
                ...
                const currentSelection = filterChildPlaceItems(this.designerCanvas.instanceServiceContainer.selectionService.selectedElements);
    ...
    _applyRotation(state, deltaAngle, commit) {
...
//# sourceMappingURL=RotateGroupExtension.js.map