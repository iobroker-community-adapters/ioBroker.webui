...
export class SkewExtension extends AbstractExtension {
    ...
    _skewXCircle;
    _skewYCircle;
    _skewXReferencePoint = { x: 0, y: 0 };
    _skewYReferencePoint = { x: 0, y: 0 };
    _activeAxis = null;
    _baseTransform = '';
    _skewX = 0;
    _skewY = 0;
    ...
    _handlePointerEvent(axis, event) {
    ...
    _setPreviewTransform() {
        this.extendedItem.element.style.transform = this._buildTransform(this._baseTransform, this._skewX, this._skewY);
    }
    _commitTransform() {
    ...
    _buildTransform(baseTransform, skewX, skewY) {
        const transforms = [];
...
//# sourceMappingURL=SkewExtension.js.map