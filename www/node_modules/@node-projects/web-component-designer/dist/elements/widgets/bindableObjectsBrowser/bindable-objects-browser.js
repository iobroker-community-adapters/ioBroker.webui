import { BaseCustomWebComponentLazyAppend, css } from '/webui/node_modules/@node-projects/base-custom-webcomponent/./dist/index.js';
...
export class BindableObjectsBrowser extends BaseCustomWebComponentLazyAppend {
    ...
    constructor() {
        ...
        if (window.importShim)
            ...
            //@ts-ignore
            import('/webui/node_modules/jquery.fancytree/dist/skin-win8/ui.fancytree.css', { assert: { type: 'css' } }).then(x => this.shadowRoot.adoptedStyleSheets = [x.default, this.constructor.style]);
