...
export class MetricsEditor extends BaseCustomWebComponentConstructorAppend {
  ...
  `;
    ...
    refresh(element) {
        ...
        const nextValues = {};
        for (const area of Object.keys(cssProperties)) {
            nextValues[area] = {};
            for (const side of Object.keys(cssProperties[area])) {
    ...
    _getComputedProperty(computedStyle, propertyName, area) {
