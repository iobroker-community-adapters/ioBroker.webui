...
export class ContextMenu {
    ...
    configurePopoverSubmenu(childmenu) {
    ...
    closeSiblingSubmenus(li) {
        ...
        for (const node of li.parentElement.children) {
            if (node !== li) {
                this.hideDescendantSubmenus(node);
            }
        }
    }
    hideDescendantSubmenus(element) {
        const submenus = element.querySelectorAll('ul[popover]');
        for (const submenu of submenus) {
            this.hidePopover(submenu);
        }
    }
    openPopoverSubmenu(li, childmenu) {
    ...
    positionMenu(menu, clickCoordsX, clickCoordsY, mouseOffset) {
    ...
    positionSubmenuPopover(li, childmenu) {
