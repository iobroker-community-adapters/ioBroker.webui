...
export const defaultOptions = {
    ...
    iconMap: {
        expanderCollapsed: new URL("../../assets/images/folder.svg", import.meta.url).toString(),
        expanderExpanded: new URL("../../assets/images/folder.svg", import.meta.url).toString(),
        expanderLazy: new URL("../../assets/images/folder.svg", import.meta.url).toString(),
        ...
        doc: new URL("../../assets/images/folder.svg", import.meta.url).toString(),
    },
    quicksearch: true,
    checkbox: false,
    source: [],
