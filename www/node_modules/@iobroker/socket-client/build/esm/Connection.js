...
export class Connection {
     ...
     */
    static isWeb() {
        return globalThis.socketUrl !== undefined;
    }
    waitForSocketLib() {
        // Only wait once
    ...
    async startSocket() {
        ...
        const urlPath = globalThis.socketPath || '';
        ...
        this._socket = connectFunc(url, {
            ...
            transports: globalThis.socketForceWebSockets ? ['websocket'] : undefined,
        });
     ...
     */
    static isCloud() {
        if (globalThis.location.hostname.includes('amazonaws.com') ||
    ...
    async doLoadData() {
        ...
        try {
            if (this.props.admin5only &&
                !Connection.isWeb() &&
                (!globalThis.vendorPrefix || globalThis.vendorPrefix === '@@vendorPrefix@@')) {
        ...
        return this.request({
            ...
            executor: (resolve, reject, timeout) => {
                ...
                if (files?.length) {
                    ...
                    this._socket.emit('cmdExec', host, cmdId, cmd, files, callback);
                }
                else {
