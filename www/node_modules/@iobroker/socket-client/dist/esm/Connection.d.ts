...
export type SystemConfig = NonNullable<ioBroker.ObjectIdToObjectType<"system.config">>;
...
export declare class Connection<CustomListenEvents extends Record<keyof CustomListenEvents, ListenEventHandler> = Record<string, never>, CustomEmitEvents extends Record<keyof CustomEmitEvents, EmitEventHandler> = Record<string, never>> {
     ...
     * @param cb The callback.
     */
    subscribeStateAsync(id: string, cb: ioBroker.StateChangeHandler): Promise<void>;
    /**
     ...
     * @param cb The callback.
     */
    subscribeFiles(id: string, filePattern: string, cb: FileChangeHandler): Promise<void>;
    /**
     ...
     * @param cb The callback.
     */
    unsubscribeFiles(id: string, filePattern: string, cb?: FileChangeHandler): void;
     ...
     * @param pattern
     */
    getForeignStates(pattern?: string | string[] | null | undefined): ioBroker.GetStatesPromise;
    /**
     ...
     * @returns {Promise<null>}
     */
    subscribeOnInstance(targetInstance: string, messageType: string, data: any | null, callback: InstanceMessageCallback): Promise<string | null>;
    /**
