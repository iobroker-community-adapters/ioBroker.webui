...
export class Connection {
    ...
    async doLoadData() {
        ...
        if (this._systemConfig) {
            this.systemLang = (_a = this._systemConfig.common) === null || _a === void 0 ? void 0 : _a.language;
            if (!this.systemLang) {
    ...
    unsubscribeState(id, cb) {
        ...
        for (let i = 0; i < ids.length; i++) {
            ...
            if (this.statesSubscribes[_id]) {
                ...
                if (!((_a = sub.cbs) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    _subscribe(isEnable) {
        ...
        if (isEnable && !this.subscribed) {
            ...
            if ((_a = this.props.autoSubscribes) === null || _a === void 0 ? void 0 : _a.length) {
            ...
            if ((_b = this.props.autoSubscribes) === null || _b === void 0 ? void 0 : _b.length) {
                    ...
                    if (err) {
                        ...
                        if (subscribeResult.error) {
                            ...
                            this._instanceSubscriptions[targetInstance] =
                                this._instanceSubscriptions[targetInstance] || [];
                            if (!this._instanceSubscriptions[targetInstance].find((subscription) => subscription.messageType ===
                                messageType &&
    ...
    unsubscribeFromInstance(targetInstance, messageType, callback) {
        ...
        do {
            deleted = false;
            const index = (_a = this._instanceSubscriptions[targetInstance]) === null || _a === void 0 ? void 0 : _a.findIndex((sub) => (!messageType || sub.messageType === messageType) &&
                (!callback || sub.callback === callback));
            if (index !== undefined && index !== null && index !== -1) {
                deleted = true;
                // remember messageType
                const _messageType = this._instanceSubscriptions[targetInstance][index]
                    .messageType;
                ...
                if (!found) {
                    promiseResults.push(this.request({
                        commandTimeout: false,
                        executor: (resolve, reject) => {
                            this._socket.emit("clientUnsubscribe", targetInstance, messageType, (err, wasSubscribed) => err
                                ? reject(err)
