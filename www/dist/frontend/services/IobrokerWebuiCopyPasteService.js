import { CopyPasteAsJsonService, DesignItem, getFromClipboard } from "@node-projects/web-component-designer";
        ...
        if (items != null) {
            try {
                ...
                if (imageFmt) {
                    ...
                    let name = items[0].name ?? 'image_' + (new Date).toISOString().replaceAll("-", "_").replaceAll("T", "_").replaceAll(":", "_").substring(0, 19);
