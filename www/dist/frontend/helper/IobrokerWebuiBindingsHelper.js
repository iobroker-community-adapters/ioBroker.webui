...
export class IobrokerWebuiBindingsHelper {
            ...
            if (s[0] == '?') {
                ...
                if (s.includes('{')) {
                    ...
                    if (binding[1].historic) {
                        ...
                        const cb = (id, value) => IobrokerWebuiBindingsHelper.handleValueChanged(element, binding, value.val, valuesObject, i, signalVars, false);
    ...
    static addTwoWayBinding(binding, element, setter) {
    ...
    static handleValueChanged(element, binding, value, valuesObject, index, signalVarNames, noParse) {
        let v = value;
        //should this be done??
        if (!noParse && index == 0)
            v = IobrokerWebuiBindingsHelper.parseValueWithType(v, binding);
