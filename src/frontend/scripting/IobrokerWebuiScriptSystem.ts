import type { contextType } from "@node-projects/web-component-designer-visualization-addons";
import type { WebuiScriptCommands } from "./IobrokerWebuiScriptCommands.js";
...
export class IobrokerWebuiScriptSystem extends ScriptSystem {
    //@ts-ignore
    override async runScriptCommand<T extends WebuiScriptCommands>(command: T, context) {
        switch (command.type) {
            case 'CloseDialog': {
