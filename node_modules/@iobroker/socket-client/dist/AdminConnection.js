...
class AdminConnection extends Connection_1.Connection {
    constructor(props) {
        super(props);
    }
            ...
            executor: (resolve, reject) => {
                this._socket.emit("getObjectView", "system", "host", { startkey: "system.host.", endkey: "system.host.\u9999" }, (err, doc) => {
                    if (err) {
                        ...
                        resolve((0, tools_1.getObjectViewResultToArray)(doc));
                    }
                });
            },
        });
    ...
    getHostInfo(host, update, timeoutMs) {
        host = (0, tools_1.normalizeHostId)(host);
        return this.request({
    ...
    readBaseSettings(host) {
        ...
        host = (0, tools_1.objectIdToHostname)(host);
        return this.request({
    ...
    getHostByIp(ipOrHostName, update) {
        // Make sure we deal with a hostname, not an object ID
        ipOrHostName = (0, tools_1.objectIdToHostname)(ipOrHostName);
        return this.request({
